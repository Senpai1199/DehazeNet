...
def compute_image_mscn_transform(image,
                                 C=1,
                                 avg_window=None,
    ...
    scipy.ndimage.correlate1d(mu_image,
                              avg_window,
                              1,
                              mu_image,
                              mode=extend_mode)
    scipy.ndimage.correlate1d(image**2,
                              avg_window,
                              0,
                              var_image,
                              mode=extend_mode)
    scipy.ndimage.correlate1d(var_image,
                              avg_window,
                              1,
                              var_image,
                              mode=extend_mode)
...
if __name__ == "__main__":
    ...
    print("NIQE score for input image is: ",
          niqe(img))  # high score has low quality
